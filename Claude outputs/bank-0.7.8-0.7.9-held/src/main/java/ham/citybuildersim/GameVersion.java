...
public final class GameVersion {
     ...
     * loss, BASE_LOSS_RATE of it; a borrower in trouble - a sector past
     * BusinessDebtManager.MAX_LOAN_TO_ASSETS of its assets, a family owing
     * more than half its credit ceiling in months of income - what the
     * restructure or the discharge would actually cost, scaled by how near
     * the line it is. A write-off draws the allowance first; the income
     ...
     *
     * MEASURED over eight seeds as shipped, against 0.7.7. The default run:
     ...
     * leverage warning at 2.0 where the restructure starts at 1.5; an
