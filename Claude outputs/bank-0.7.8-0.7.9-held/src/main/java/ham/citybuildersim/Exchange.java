...
public class Exchange {
    ...
    /** Shares the desk will still buy in this company: up to its capacity, and of its own only while the bank is at or over its capital target (Bank.buysBackOwnShares()). */
    double deskCanBuy(Equity register, int c) {
        ...
        if (c == Equity.BANK) {
            ...
            // minimum, whatever it wanted to hold.
