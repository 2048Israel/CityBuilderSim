# MoneyCheck.java - 219 lines · 5 methods · 0 constants · harnesses

`ham/citybuildersim/MoneyCheck.java` - generated 2026-09-18 by CodeMap; line numbers are as of that run.
...
**Uses:** [Game](Game.md) (9), [MoneyAudit](MoneyAudit.md) (5), [Sectors](Sectors.md) (5), [GameFiles](GameFiles.md) (3), [BuildingsTemplate](BuildingsTemplate.md) (2), [LandMarket](LandMarket.md) (1), [LandParcel](LandParcel.md) (1), [TaxPolicy](TaxPolicy.md) (1), [BusinessDebtManager](BusinessDebtManager.md) (1), [DebtManager](DebtManager.md) (1), [CapitalFlows](CapitalFlows.md) (1)
...
| 107 | · AND A BUS, WHICH IS THE WHOLE REASON THIS LINE EXISTS (2026-09-16). |
| 134 | · 2. a city under stress |
| 171 | · AND NOTHING MOVES AFTER THE AUDIT HAS STRUCK. |
...
|---:|---:|---|---|
| 20 | 200 | **type** `public class MoneyCheck` | Money is conserved: every dollar that leaves a pool arrives in another, or crosses the city's boundary in a way the audit can name. |
