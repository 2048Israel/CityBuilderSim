# OutsideCheck.java - 631 lines · 5 methods · 0 constants · harnesses

`ham/citybuildersim/OutsideCheck.java` - generated 2026-09-18 by CodeMap; line numbers are as of that run.
...
**Uses:** [AgeBand](AgeBand.md) (44), [FamilyModel](FamilyModel.md) (17), [FamilyStructure](FamilyStructure.md) (17), [Unemployment](Unemployment.md) (15), [PayTier](PayTier.md) (11), [PopulationCohorts](PopulationCohorts.md) (11), [HouseholdBalance](HouseholdBalance.md) (9), [Game](Game.md) (7), [HouseholdAccounts](HouseholdAccounts.md) (7), [BuildingsTemplate](BuildingsTemplate.md) (5), [UnemployedHousehold](UnemployedHousehold.md) (5), [StudentHousehold](StudentHousehold.md) (5), [Health](Health.md) (4), [JobType](JobType.md) (3), [OrphanHousehold](OrphanHousehold.md) (3), [GameFiles](GameFiles.md) (3), [PopulationManager](PopulationManager.md) (2), [WageBand](WageBand.md) (2), [Household](Household.md) (2), [EconomyManager](EconomyManager.md) (2), [MoneyAudit](MoneyAudit.md) (2), [Healthcare](Healthcare.md) (1)
...
| 519 | · 8. a city with a college: the students' money, and a save |
...
|---:|---:|---|---|
| 16 | 616 | **type** `public class OutsideCheck` | The people outside the families: the out of work, the students, the unhoused and the orphans (2026-09-11). |
...
| 44 | 587 | `public static void main(String[] args)` |  |
