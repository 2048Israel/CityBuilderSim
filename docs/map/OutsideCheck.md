...
| 558 | · 8. a city with a college: the students' money, and a save |
...
|---:|---:|---|---|
| 16 | 663 | **type** `public class OutsideCheck` | The people outside the families: the out of work, the students, the unhoused and the orphans (2026-09-11). |
...
| 44 | 634 | `public static void main(String[] args)` |  |
