# DataSave.java - 1,688 lines · 267 methods · 0 constants · model
...
**Uses:** [SectorBooks](SectorBooks.md) (6), [Founding](Founding.md) (5), [Currency](Currency.md) (4), [Notice](Notice.md) (3), [SectorState](SectorState.md) (3), [Markets](Markets.md) (3), [DemolitionLog](DemolitionLog.md) (3), [BuildLog](BuildLog.md) (3), [GameFiles](GameFiles.md) (3), [SalesTaxLedger](SalesTaxLedger.md) (3), [TaxPolicy](TaxPolicy.md) (3), [Exchange](Exchange.md) (3), [BondMarket](BondMarket.md) (3), [Debt](Debt.md) (1), [BusinessDebt](BusinessDebt.md) (1)
...
| 1039 | `private double[] priceIndex` | The price basket, its weights, and a year of readings. |
| 1052 | `private double[] worldEconomy` | The world's price level and what it is rising at. |
| 1068 | `private double tradedExchangeRate` | THE RATE THE MONTH WAS TRADED AT, as EconomyManager holds it: the foreign rate times the world's price level, struck at the top of the month and fanned out to the food market and the building manager. |
| 1083 | `private double[] denomination` | The currency's unit and how many reforms it has been through. |
| 1098 | `private Double policyRate` | The policy rate. |
| 1109 | `private Boolean policyAutopilot` | Whether the rule held the dial when this was saved (0.7.0) - see DebtManager's autopilot. |
| 1120 | `private Boolean landPaidFromVault` | How the land office pays (0.7.6) - Game.isLandPaidFromVault(): true out of the vault's dollars, false converting cash. |
| 1133 | `private Double inflationTarget` | The inflation target the rule aims at (0.7.4) - DebtManager .getInflationTarget(). |
| 1146 | `private double qeTargetShare` | The central bank's holdings dial (0.7.1): the share of the city's term paper it aims to hold - CentralBank.getTargetShare(). |
| 1160 | `private Double advancesCeilingMonths` | The advances ceiling dial (0.7.2): the most the treasury may owe its central bank, in months of its revenue - CentralBank .getAdvancesCeilingMonths(). |
| 1173 | `private double householdPaperRatio` | The month's ratio for the households' city paper (0.7.1): their book at the curve over its face, which their plan reads - so it is carried, and the load path re-strikes the plan on the figure the live path used. |
| 1192 | `private BondMarket.State bondMarket` | THE BUSINESSES' BONDS (0.7.12): every bond and who holds it, every order book's resting orders, the market's month and its record over the city's life (BondMarket.State); what defaults have taken off the bonds, by sec... |
| 1193 | `private java.util.Map<String, Double> bondWrittenOff` |  |
| 1194 | `private double householdBondRatio` |  |
| 1195 | `private java.util.Map<String, java.util.Map<String, Double>> householdBondsByCell` |  |
| 1212 | `private double buybackToHouseholdsUnsettled` | What a buyback between two presses paid the households and a dollar bond's holders and the next month has not yet declared (0.7.1) - Game.getBuybackUnsettled() less the central bank's share, which rides in its own array. |
| 1213 | `private double buybackAbroadUnsettled` |  |
| 1236 | `private double rememberedCommute` | The commute the city REMEMBERS, which decides how many of its car owners get on a tram - see InfrastructureManager.noteCongestion(). |
| 1242 | `private double carsPerHousehold` | Cars per household, as the road read it. |
| 1259 | `private double costOfLiving` | How far wages have chased the cost of living. |
| 1273 | `private double bankTaxCharged` | The tax the city actually took off the bank this month. |
| 1299 | `private double rentWeightStudio` | The studio half of that weight, added 2026-09-09 with the segment split. |
| 1328 | `private double[] cohorts` | The demographics. |
| 1352 | `private String[] bandNames` | THE AGE BANDS THIS WHOLE SAVE WAS WRITTEN WITH (2026-09-15). |
| 1354 | `private double[] families` |  |
| 1355 | `private double[] migration` |  |
| 1365 | `private double[] unemployment` | The people out of work: the EI claims by the month they began, who is past EI, who has been evicted, and the month the flows were struck against (2026-09-11). |
| 1374 | `private double[] sickness` | Who has been sick how long: five rings of thirteen monthly shares, the last month's deaths from sickness by band, the recovery and whether the ring has been seeded (2026-09-11). |
| 1384 | `private double[] crime` | Crime and the prisons (2026-09-11): six monthly cohorts of prisoners, the month as it was struck - the rate next month's migration reads, the killings next month's pyramid reads - and the running totals. |
| 1397 | `private double[] health` | The month's sickness: the outbreak still decaying, and the rate the sectors were throttled by. |
| 1410 | `private double[] healthcare` | The health service: plots used, the unburied backlog, and the month's bill. |
| 1426 | `private double[] labour` | The minimum wage, then the eleven wages the city is actually paying. |
| 1438 | `private double[] skilledWorkforce` | How many skilled workers the city has, by band. |
| 1455 | `private double[] licences` | Who is licensed to practise what, and the schools' running total. |
| 1456 | `private double[] education` |  |
| 1485 | `private String[] shapeNames` | The household shapes this save was written with. |
| 1518 | `private java.util.Map<String, Integer> sectorLossMonths` | The private sector's memory, and the player's own turn. |
| 1519 | `private java.util.List<Integer> populationTrend` |  |
| 1520 | `private double cityCapitalSpending` |  |
| 1521 | `private double monthlyMaterialImports` |  |
| 1528 | `private double monthlyMaterialImportBill` | The same imports in money, at the price each was charged at - the builders' materials expense and the accounts' import line. |
| 1529 | `private int materialsConsumed` |  |
| 1552 | `private double cityMaintenancePaid` | What the treasury paid the builders to keep the city's own buildings up. |
| 1569 | `private java.util.Map<String, Double> subsidyPaid` | What each protected sector was paid last month. |
| 1580 | `private double[] householdStatement` | The residents' month: twelve scalars and eleven per-tier arrays. |

## Methods, in file order, under their sections

| line | len | member | says |
|---:|---:|---|---|
| 12 | 1677 | **type** `public class DataSave` |  |
...
| 1041 | 1 | `public void setPriceIndex(double[] state)` |  |
| 1042 | 1 | `public double[] getPriceIndex()` |  |
| 1054 | 1 | `public void setWorldEconomy(double[] state)` |  |
| 1055 | 1 | `public double[] getWorldEconomy()` |  |
| 1070 | 1 | `public void setTradedExchangeRate(double rate)` |  |
| 1071 | 1 | `public double getTradedExchangeRate()` |  |
| 1085 | 1 | `public void setDenomination(double[] state)` |  |
| 1086 | 1 | `public double[] getDenomination()` |  |
| 1100 | 1 | `public void setPolicyRate(double rate)` |  |
| 1102 | 1 | `public Double getPolicyRate()` | The rate as saved, or null on a save that did not carry one. |
| 1111 | 1 | `public void setPolicyAutopilot(boolean on)` |  |
| 1112 | 1 | `public boolean getPolicyAutopilot()` |  |
| 1122 | 1 | `public void setLandPaidFromVault(boolean fromVault)` |  |
| 1123 | 1 | `public boolean getLandPaidFromVault()` |  |
| 1135 | 1 | `public void setInflationTarget(double target)` |  |
| 1137 | 1 | `public Double getInflationTarget()` | The target as saved, or null on a save from before the dial. |
| 1148 | 1 | `public void setQeTargetShare(double share)` |  |
| 1149 | 1 | `public double getQeTargetShare()` |  |
| 1162 | 1 | `public void setAdvancesCeilingMonths(double months)` |  |
| 1164 | 1 | `public Double getAdvancesCeilingMonths()` | The ceiling as saved, or null on a save from before the dial. |
| 1175 | 1 | `public void setHouseholdPaperRatio(double ratio)` |  |
| 1176 | 1 | `public double getHouseholdPaperRatio()` |  |
| 1197 | 1 | `public void setBondMarket(BondMarket.State state)` |  |
| 1198 | 1 | `public BondMarket.State getBondMarket()` |  |
| 1199 | 1 | `public void setBondWrittenOff(java.util.Map<String, Double> totals)` |  |
| 1200 | 1 | `public java.util.Map<String, Double> getBondWrittenOff()` |  |
| 1201 | 1 | `public void setHouseholdBondRatio(double ratio)` |  |
| 1202 | 1 | `public double getHouseholdBondRatio()` |  |
| 1203 | 1 | `public void setHouseholdBondsByCell(java.util.Map<String, java.util.Map<String, Double>> byCell)` |  |
| 1204 | 1 | `public java.util.Map<String, java.util.Map<String, Double>> getHouseholdBondsByCell()` |  |
| 1215 | 4 | `public void setBuybackUnsettled(double households, double abroad)` |  |
| 1219 | 1 | `public double getBuybackToHouseholdsUnsettled()` |  |
| 1220 | 1 | `public double getBuybackAbroadUnsettled()` |  |
| 1244 | 1 | `public void setCarsPerHousehold(double v)` |  |
| 1245 | 1 | `public double getCarsPerHousehold()` |  |
| 1247 | 1 | `public void setRememberedCommute(double v)` |  |
| 1248 | 3 | `public double getRememberedCommute()` |  |
| 1261 | 1 | `public void setCostOfLiving(double v)` |  |
| 1262 | 1 | `public double getCostOfLiving()` |  |
| 1275 | 1 | `public void setBankTaxCharged(double v)` |  |
| 1276 | 1 | `public double getBankTaxCharged()` |  |
| 1280 | 1 | `public void setRentWeight(double weight)` | What the landlords billed this month - see FamilyModel.setRentWeight(). |
| 1281 | 1 | `public double getRentWeight()` |  |
| 1301 | 1 | `public void setRentWeightStudio(double weight)` |  |
| 1302 | 1 | `public double getRentWeightStudio()` |  |
| 1304 | 4 | `public void setConstructionShedding(int month, double points)` |  |
| 1308 | 1 | `public int getConstructionShedMonth()` |  |
| 1309 | 1 | `public double getConstructionShedPoints()` |  |
| 1311 | 3 | `public void setDemolitions(java.util.List<DemolitionLog.Entry> entries)` |  |
| 1314 | 1 | `public java.util.List<DemolitionLog.Entry> getDemolitions()` |  |
| 1458 | 1 | `public void setLicences(double[] a)` |  |
| 1459 | 1 | `public double[] getLicences()` |  |
| 1460 | 1 | `public void setEducation(double[] a)` |  |
| 1461 | 1 | `public double[] getEducation()` |  |
| 1463 | 1 | `public void setLabour(double[] a)` |  |
| 1464 | 1 | `public double[] getLabour()` |  |
| 1465 | 1 | `public void setSkilledWorkforce(double[] a)` |  |
| 1466 | 1 | `public double[] getSkilledWorkforce()` |  |
| 1468 | 1 | `public void setCohorts(double[] a)` |  |
| 1469 | 1 | `public double[] getCohorts()` |  |
| 1472 | 1 | `public void setBandNames(String[] names)` |  |
| 1474 | 1 | `public String[] getBandNames()` | Null on a save from before the names travelled: read it as LEGACY_BANDS. |
| 1488 | 1 | `public void setShapeNames(String[] names)` |  |
| 1489 | 1 | `public String[] getShapeNames()` |  |
| 1490 | 1 | `public void setFamilies(double[] a)` |  |
| 1491 | 1 | `public double[] getFamilies()` |  |
| 1492 | 1 | `public void setMigration(double[] a)` |  |
| 1493 | 1 | `public double[] getMigration()` |  |
| 1494 | 1 | `public void setUnemployment(double[] a)` |  |
| 1495 | 1 | `public double[] getUnemployment()` |  |
| 1496 | 1 | `public void setSickness(double[] a)` |  |
| 1497 | 1 | `public double[] getSickness()` |  |
| 1498 | 1 | `public void setCrime(double[] a)` |  |
| 1499 | 1 | `public double[] getCrime()` |  |
| 1500 | 1 | `public void setHealth(double[] a)` |  |
| 1501 | 1 | `public double[] getHealth()` |  |
| 1502 | 1 | `public void setHealthcare(double[] a)` |  |
| 1503 | 1 | `public double[] getHealthcare()` |  |
| 1531 | 1 | `public void setSectorLossMonths(java.util.Map<String, Integer> m)` |  |
| 1532 | 1 | `public java.util.Map<String, Integer> getSectorLossMonths()` |  |
| 1533 | 1 | `public void setPopulationTrend(java.util.List<Integer> l)` |  |
| 1534 | 1 | `public java.util.List<Integer> getPopulationTrend()` |  |
| 1535 | 1 | `public void setCityCapitalSpending(double v)` |  |
| 1536 | 1 | `public double getCityCapitalSpending()` |  |
| 1554 | 1 | `public void setCityMaintenancePaid(double v)` |  |
| 1555 | 1 | `public double getCityMaintenancePaid()` |  |
| 1556 | 1 | `public void setMonthlyMaterialImports(double v)` |  |
| 1557 | 1 | `public double getMonthlyMaterialImports()` |  |
| 1558 | 1 | `public void setMonthlyMaterialImportBill(double v)` |  |
| 1559 | 1 | `public double getMonthlyMaterialImportBill()` |  |
| 1560 | 1 | `public void setMaterialsConsumed(int v)` |  |
| 1561 | 1 | `public int getMaterialsConsumed()` |  |
| 1570 | 1 | `public void setSubsidyPaid(java.util.Map<String, Double> v)` |  |
| 1571 | 1 | `public java.util.Map<String, Double> getSubsidyPaid()` |  |
| 1581 | 1 | `public void setHouseholdStatement(double[] v)` |  |
| 1582 | 1 | `public double[] getHouseholdStatement()` |  |
| 1584 | 3 | `public void setBuilds(java.util.List<BuildLog.Entry> entries)` |  |
| 1587 | 1 | `public java.util.List<BuildLog.Entry> getBuilds()` |  |
| 1589 | 3 | `public void setWriteOffTotals(java.util.Map<String, Double> totals)` |  |
| 1592 | 1 | `public java.util.Map<String, Double> getWriteOffTotals()` |  |
| 1594 | 3 | `public void setRestructureCounts(java.util.Map<String, Integer> counts)` |  |
| 1597 | 1 | `public java.util.Map<String, Integer> getRestructureCounts()` |  |
| 1599 | 3 | `public void setBlockedMonths(java.util.Map<String, Integer> months)` |  |
| 1602 | 1 | `public java.util.Map<String, Integer> getBlockedMonths()` |  |
| 1604 | 3 | `public void setCreditStatements(java.util.Map<String, double[]> statements)` |  |
| 1607 | 1 | `public java.util.Map<String, double[]> getCreditStatements()` |  |
| 1609 | 1 | `public void setMortgageRepaid(java.util.Map<String, Double> repaid)` |  |
| 1610 | 1 | `public java.util.Map<String, Double> getMortgageRepaid()` |  |
| 1612 | 1 | `public void setInsuranceClaims(java.util.Map<String, Double> claims)` |  |
| 1613 | 1 | `public java.util.Map<String, Double> getInsuranceClaims()` |  |
| 1615 | 1 | `public void setInsurancePremiums(double premiums)` |  |
| 1616 | 1 | `public double getInsurancePremiums()` |  |
| 1618 | 1 | `public void setNationalAccounts(double[] state)` |  |
| 1619 | 1 | `public double[] getNationalAccounts()` |  |
| 1629 | 3 | `public int getUnderConstructionLength()` | Null-safe, because new saves no longer write the legacy arrays at all. |
| 1632 | 3 | `public int getUnderConstruction(int index)` |  |
| 1635 | 3 | `public double getCash()` |  |
| 1639 | 3 | `public int getMonth()` |  |
| 1643 | 3 | `public int getBuildingQuantity(int index)` |  |
| 1647 | 3 | `public int getBuildingsLength()` |  |
| 1651 | 3 | `public JsonArray getDebt()` |  |
| 1655 | 4 | `public void setBusinessDebt(List<BusinessDebt> loans)` |  |
| 1660 | 3 | `public JsonArray getBusinessDebt()` |  |
| 1664 | 3 | `public int getProgressLength()` |  |
| 1668 | 3 | `public double getProgress(int index)` |  |
| 1672 | 3 | `public int getConstructionMaterials()` |  |
| 1676 | 3 | `public int getPopulation()` |  |
| 1679 | 3 | `public boolean getReports()` |  |
| 1682 | 3 | `public java.util.List<Notice> getNotices()` |  |
| 1685 | 3 | `public boolean getGraphs()` |  |
