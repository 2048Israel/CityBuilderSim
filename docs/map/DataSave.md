# DataSave.java - 1,341 lines · 213 methods · 0 constants · model
...
| 720 | `private double[] foreignAccounts` | The city's foreign position: reserves, the trailing import bill the cover is measured against, how many months have been counted into it, and the exchange rate. |
| 733 | `private double[] foreignStanding` | The city's standing with foreign lenders: the default scar and how long ago it was earned. |
| 745 | `private double[] capitalFlows` | Hot money: how much is here, and how long the city has left to sweat. |
| 756 | `private double[] outwardInvestment` | The city's own savings abroad, per sector. |
| 767 | `private String[] equityKeys` | The share register, company by company, named. |
| 768 | `private double[] equity` |  |
| 775 | `private double[] exchange` | The exchange's quotes, company by company, named. |
| 789 | `private double[] bankSolvency` | How often the bank has failed, what its creditors ate, and whether it is frozen right now. |
| 808 | `private double[] housingOccupancy` | Doors that were lived in when the month's housing pass ran. |
| 822 | `private double[] bankLastMonth` | The bank's last CLOSED month: payroll, upkeep, interest earned, book. |
| 834 | `private double[] priceIndex` | The price basket, its weights, and a year of readings. |
| 847 | `private double[] worldEconomy` | The world's price level and what it is rising at. |
| 863 | `private double tradedExchangeRate` | THE RATE THE MONTH WAS TRADED AT, as EconomyManager holds it: the foreign rate times the world's price level, struck at the top of the month and fanned out to the food market and the building manager. |
| 878 | `private double[] denomination` | The currency's unit and how many reforms it has been through. |
| 884 | `private double policyRate` | The policy rate. |
| 903 | `private double rememberedCommute` | The commute the city REMEMBERS, which decides how many of its car owners get on a tram - see InfrastructureManager.noteCongestion(). |
| 909 | `private double carsPerHousehold` | Cars per household, as the road read it. |
| 926 | `private double costOfLiving` | How far wages have chased the cost of living. |
| 940 | `private double bankTaxCharged` | The tax the city actually took off the bank this month. |
| 966 | `private double rentWeightStudio` | The studio half of that weight, added 2026-09-09 with the segment split. |
| 995 | `private double[] cohorts` | The demographics. |
| 1019 | `private String[] bandNames` | THE AGE BANDS THIS WHOLE SAVE WAS WRITTEN WITH (2026-09-15). |
| 1021 | `private double[] families` |  |
| 1022 | `private double[] migration` |  |
| 1032 | `private double[] unemployment` | The people out of work: the EI claims by the month they began, who is past EI, who has been evicted, and the month the flows were struck against (2026-09-11). |
| 1041 | `private double[] sickness` | Who has been sick how long: five rings of thirteen monthly shares, the last month's deaths from sickness by band, the recovery and whether the ring has been seeded (2026-09-11). |
| 1051 | `private double[] crime` | Crime and the prisons (2026-09-11): six monthly cohorts of prisoners, the month as it was struck - the rate next month's migration reads, the killings next month's pyramid reads - and the running totals. |
| 1064 | `private double[] health` | The month's sickness: the outbreak still decaying, and the rate the sectors were throttled by. |
| 1077 | `private double[] healthcare` | The health service: plots used, the unburied backlog, and the month's bill. |
| 1093 | `private double[] labour` | The minimum wage, then the eleven wages the city is actually paying. |
| 1105 | `private double[] skilledWorkforce` | How many skilled workers the city has, by band. |
| 1122 | `private double[] licences` | Who is licensed to practise what, and the schools' running total. |
| 1123 | `private double[] education` |  |
| 1152 | `private String[] shapeNames` | The household shapes this save was written with. |
| 1185 | `private java.util.Map<String, Integer> sectorLossMonths` | The private sector's memory, and the player's own turn. |
| 1186 | `private java.util.List<Integer> populationTrend` |  |
| 1187 | `private double cityCapitalSpending` |  |
| 1188 | `private double monthlyMaterialImports` |  |
| 1195 | `private double monthlyMaterialImportBill` | The same imports in money, at the price each was charged at - the builders' materials expense and the accounts' import line. |
| 1196 | `private int materialsConsumed` |  |
| 1219 | `private double cityMaintenancePaid` | What the treasury paid the builders to keep the city's own buildings up. |
| 1236 | `private java.util.Map<String, Double> subsidyPaid` | What each protected sector was paid last month. |
| 1247 | `private double[] householdStatement` | The residents' month: twelve scalars and eleven per-tier arrays. |

## Methods, in file order, under their sections

| line | len | member | says |
|---:|---:|---|---|
| 12 | 1330 | **type** `public class DataSave` |  |
...
| 722 | 1 | `public void setForeignAccounts(double[] state)` |  |
| 723 | 1 | `public double[] getForeignAccounts()` |  |
| 735 | 1 | `public void setForeignStanding(double[] state)` |  |
| 736 | 1 | `public double[] getForeignStanding()` |  |
| 747 | 1 | `public void setCapitalFlows(double[] state)` |  |
| 748 | 1 | `public double[] getCapitalFlows()` |  |
| 758 | 1 | `public void setOutwardInvestment(double[] state)` |  |
| 759 | 1 | `public double[] getOutwardInvestment()` |  |
| 770 | 1 | `public void setEquity(String[] keys, double[] state)` |  |
| 771 | 1 | `public String[] getEquityKeys()` |  |
| 772 | 1 | `public double[] getEquity()` |  |
| 776 | 1 | `public void setExchange(double[] state)` |  |
| 777 | 1 | `public double[] getExchange()` |  |
| 791 | 1 | `public void setBankSolvency(double[] state)` |  |
| 792 | 1 | `public double[] getBankSolvency()` |  |
| 810 | 1 | `public void setHousingOccupancy(double[] state)` |  |
| 811 | 1 | `public double[] getHousingOccupancy()` |  |
| 824 | 1 | `public void setBankLastMonth(double[] state)` |  |
| 825 | 1 | `public double[] getBankLastMonth()` |  |
| 836 | 1 | `public void setPriceIndex(double[] state)` |  |
| 837 | 1 | `public double[] getPriceIndex()` |  |
| 849 | 1 | `public void setWorldEconomy(double[] state)` |  |
| 850 | 1 | `public double[] getWorldEconomy()` |  |
| 865 | 1 | `public void setTradedExchangeRate(double rate)` |  |
| 866 | 1 | `public double getTradedExchangeRate()` |  |
| 880 | 1 | `public void setDenomination(double[] state)` |  |
| 881 | 1 | `public double[] getDenomination()` |  |
| 886 | 1 | `public void setPolicyRate(double rate)` |  |
| 887 | 1 | `public double getPolicyRate()` |  |
| 911 | 1 | `public void setCarsPerHousehold(double v)` |  |
| 912 | 1 | `public double getCarsPerHousehold()` |  |
| 914 | 1 | `public void setRememberedCommute(double v)` |  |
| 915 | 3 | `public double getRememberedCommute()` |  |
| 928 | 1 | `public void setCostOfLiving(double v)` |  |
| 929 | 1 | `public double getCostOfLiving()` |  |
| 942 | 1 | `public void setBankTaxCharged(double v)` |  |
| 943 | 1 | `public double getBankTaxCharged()` |  |
| 947 | 1 | `public void setRentWeight(double weight)` | What the landlords billed this month - see FamilyModel.setRentWeight(). |
| 948 | 1 | `public double getRentWeight()` |  |
| 968 | 1 | `public void setRentWeightStudio(double weight)` |  |
| 969 | 1 | `public double getRentWeightStudio()` |  |
| 971 | 4 | `public void setConstructionShedding(int month, double points)` |  |
| 975 | 1 | `public int getConstructionShedMonth()` |  |
| 976 | 1 | `public double getConstructionShedPoints()` |  |
| 978 | 3 | `public void setDemolitions(java.util.List<DemolitionLog.Entry> entries)` |  |
| 981 | 1 | `public java.util.List<DemolitionLog.Entry> getDemolitions()` |  |
| 1125 | 1 | `public void setLicences(double[] a)` |  |
| 1126 | 1 | `public double[] getLicences()` |  |
| 1127 | 1 | `public void setEducation(double[] a)` |  |
| 1128 | 1 | `public double[] getEducation()` |  |
| 1130 | 1 | `public void setLabour(double[] a)` |  |
| 1131 | 1 | `public double[] getLabour()` |  |
| 1132 | 1 | `public void setSkilledWorkforce(double[] a)` |  |
| 1133 | 1 | `public double[] getSkilledWorkforce()` |  |
| 1135 | 1 | `public void setCohorts(double[] a)` |  |
| 1136 | 1 | `public double[] getCohorts()` |  |
| 1139 | 1 | `public void setBandNames(String[] names)` |  |
| 1141 | 1 | `public String[] getBandNames()` | Null on a save from before the names travelled: read it as LEGACY_BANDS. |
| 1155 | 1 | `public void setShapeNames(String[] names)` |  |
| 1156 | 1 | `public String[] getShapeNames()` |  |
| 1157 | 1 | `public void setFamilies(double[] a)` |  |
| 1158 | 1 | `public double[] getFamilies()` |  |
| 1159 | 1 | `public void setMigration(double[] a)` |  |
| 1160 | 1 | `public double[] getMigration()` |  |
| 1161 | 1 | `public void setUnemployment(double[] a)` |  |
| 1162 | 1 | `public double[] getUnemployment()` |  |
| 1163 | 1 | `public void setSickness(double[] a)` |  |
| 1164 | 1 | `public double[] getSickness()` |  |
| 1165 | 1 | `public void setCrime(double[] a)` |  |
| 1166 | 1 | `public double[] getCrime()` |  |
| 1167 | 1 | `public void setHealth(double[] a)` |  |
| 1168 | 1 | `public double[] getHealth()` |  |
| 1169 | 1 | `public void setHealthcare(double[] a)` |  |
| 1170 | 1 | `public double[] getHealthcare()` |  |
| 1198 | 1 | `public void setSectorLossMonths(java.util.Map<String, Integer> m)` |  |
| 1199 | 1 | `public java.util.Map<String, Integer> getSectorLossMonths()` |  |
| 1200 | 1 | `public void setPopulationTrend(java.util.List<Integer> l)` |  |
| 1201 | 1 | `public java.util.List<Integer> getPopulationTrend()` |  |
| 1202 | 1 | `public void setCityCapitalSpending(double v)` |  |
| 1203 | 1 | `public double getCityCapitalSpending()` |  |
| 1221 | 1 | `public void setCityMaintenancePaid(double v)` |  |
| 1222 | 1 | `public double getCityMaintenancePaid()` |  |
| 1223 | 1 | `public void setMonthlyMaterialImports(double v)` |  |
| 1224 | 1 | `public double getMonthlyMaterialImports()` |  |
| 1225 | 1 | `public void setMonthlyMaterialImportBill(double v)` |  |
| 1226 | 1 | `public double getMonthlyMaterialImportBill()` |  |
| 1227 | 1 | `public void setMaterialsConsumed(int v)` |  |
| 1228 | 1 | `public int getMaterialsConsumed()` |  |
| 1237 | 1 | `public void setSubsidyPaid(java.util.Map<String, Double> v)` |  |
| 1238 | 1 | `public java.util.Map<String, Double> getSubsidyPaid()` |  |
| 1248 | 1 | `public void setHouseholdStatement(double[] v)` |  |
| 1249 | 1 | `public double[] getHouseholdStatement()` |  |
| 1251 | 3 | `public void setBuilds(java.util.List<BuildLog.Entry> entries)` |  |
| 1254 | 1 | `public java.util.List<BuildLog.Entry> getBuilds()` |  |
| 1256 | 3 | `public void setWriteOffTotals(java.util.Map<String, Double> totals)` |  |
| 1259 | 1 | `public java.util.Map<String, Double> getWriteOffTotals()` |  |
| 1261 | 3 | `public void setRestructureCounts(java.util.Map<String, Integer> counts)` |  |
| 1264 | 1 | `public java.util.Map<String, Integer> getRestructureCounts()` |  |
| 1266 | 3 | `public void setBlockedMonths(java.util.Map<String, Integer> months)` |  |
| 1269 | 1 | `public java.util.Map<String, Integer> getBlockedMonths()` |  |
| 1271 | 1 | `public void setNationalAccounts(double[] state)` |  |
| 1272 | 1 | `public double[] getNationalAccounts()` |  |
| 1282 | 3 | `public int getUnderConstructionLength()` | Null-safe, because new saves no longer write the legacy arrays at all. |
| 1285 | 3 | `public int getUnderConstruction(int index)` |  |
| 1288 | 3 | `public double getCash()` |  |
| 1292 | 3 | `public int getMonth()` |  |
| 1296 | 3 | `public int getBuildingQuantity(int index)` |  |
| 1300 | 3 | `public int getBuildingsLength()` |  |
| 1304 | 3 | `public JsonArray getDebt()` |  |
| 1308 | 4 | `public void setBusinessDebt(List<BusinessDebt> loans)` |  |
| 1313 | 3 | `public JsonArray getBusinessDebt()` |  |
| 1317 | 3 | `public int getProgressLength()` |  |
| 1321 | 3 | `public double getProgress(int index)` |  |
| 1325 | 3 | `public int getConstructionMaterials()` |  |
| 1329 | 3 | `public int getPopulation()` |  |
| 1332 | 3 | `public boolean getReports()` |  |
| 1335 | 3 | `public java.util.List<Notice> getNotices()` |  |
| 1338 | 3 | `public boolean getGraphs()` |  |
