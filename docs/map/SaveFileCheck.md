# SaveFileCheck.java - 1,326 lines · 7 methods · 0 constants · harnesses
...
**Uses:** [GameFiles](GameFiles.md) (40), [Game](Game.md) (33), [Bank](Bank.md) (7), [BuildingsTemplate](BuildingsTemplate.md) (5), [Sectors](Sectors.md) (5), [Sector](Sector.md) (5), [EconomyManager](EconomyManager.md) (5), [DataSave](DataSave.md) (4), [Household](Household.md) (3), [HistorySave](HistorySave.md) (2), [BuildingManager](BuildingManager.md) (2), [Construction](Construction.md) (2), [TaxPolicy](TaxPolicy.md) (2), [WageBand](WageBand.md) (2), [BusinessDebtManager](BusinessDebtManager.md) (2), [TreasuryJournal](TreasuryJournal.md) (2), [Good](Good.md) (1), [PopulationManager](PopulationManager.md) (1), [Retail](Retail.md) (1), [ForeignAccounts](ForeignAccounts.md) (1)
...
| 854 | · 12b. ...AND ONE THAT OWES ABROAD (2026-09-21) |
| 904 | · 13. AND NOTHING READS ZERO ON A FRESHLY LOADED CITY |
...
|---:|---:|---|---|
| 23 | 1304 | **type** `public class SaveFileCheck` | Verifies where saves go and how they are written. |
...
| 59 | 1251 | `public static void main(String[] args) throws Exception` |  |
| 1311 | 6 | `static BuildingsTemplate template(Game game, String name)` |  |
| 1319 | 7 | `static void cleanUp(Path root)` | Temp directory only - nothing here ever points at a real save folder. |
