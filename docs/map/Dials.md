# Dials.java - 55 lines · 2 methods · 0 constants · tools

`ham/citybuildersim/tools/Dials.java` - generated 2026-09-23 by CodeMap; line numbers are as of that run.
...
**Uses:** [SourceTree](SourceTree.md) (8), [JavaScan](JavaScan.md) (5)
...
|---:|---:|---|---|
| 21 | 35 | **type** `public final class Dials` | Every dial in the game on one page: docs/dials.md lists each static final constant in the tree with its value, its line, and the sentence above it. |
| 23 | 3 | `public static void main(String[] args) throws IOException` |  |
| 27 | 28 | `static void run(SourceTree tree) throws IOException` |  |
