...
**The tree:** 203 files, 123,117 lines, 4,785 methods, 682 constants. `GameVersion.VERSION` is "0.6.7", `SAVE_FORMAT` 27.
...
| [Bank.java](Bank.md) | 2,213 | 133 | The city's commercial bank: every loan in it, and every default. | 19 |
...
| [BuildingManager.java](BuildingManager.md) | 4,291 | 106 | sections: WATER DRAW, per building, in units of 10,000 gallons/month., HEALTHCARE... | 45 |
...
| [DataSave.java](DataSave.md) | 1,304 | 206 | sections: land, ore and the retainer, the shedding warning... | 3 |
| [Debt.java](Debt.md) | 351 | 31 | One piece of city paper. | 13 |
| [DebtManager.java](DebtManager.md) | 1,018 | 80 | sections: THE POLICY RATE, THE RATE THE FOREIGN PAPER IS VALUED AT... | 18 |
| [DebtQuote.java](DebtQuote.md) | 163 | 8 | What a loan would cost, worked out BEFORE the player agrees to it. | 5 |
...
| [Education.java](Education.md) | 873 | 43 | Who the city teaches, what it costs, and why anybody bothers. | 8 |
...
| [FamilyModel.java](FamilyModel.md) | 2,051 | 97 | How the city's people are arranged into households, and what each earns. | 19 |
| [FamilyStructure.java](FamilyStructure.md) | 119 | 7 | The shapes a household comes in. | 24 |
| [ForeignAccounts.java](ForeignAccounts.md) | 1,112 | 68 | The city's dealings with the rest of the world: the balance of payments, the reserve position, and the exchange rate. | 15 |
| [Formats.java](Formats.md) | 56 | 6 | The few formats a sector needs to describe itself, without the toolkit. | 16 |
| [Game.java](Game.md) | 7,810 | 274 | sections: THE CONSTRUCTION SUBSIDY, STANDING POLICY: NEVER LET THIS SECTOR SHRINK... | 88 |
...
| [GameVersion.java](GameVersion.md) | 608 | 4 | What build this is, and what shape its saves are. | 7 |
...
| [Household.java](Household.md) | 908 | 81 | Every household of one shape at one pay tier, as one ledger. | 22 |
...
| [LabourMarket.java](LabourMarket.md) | 731 | 36 | What labour costs, and why it costs that. | 10 |
| [LandManager.java](LandManager.md) | 445 | 41 | The city's land: what it owns, what is built on, and what it sells. | 11 |
...
| [MoneyAudit.java](MoneyAudit.md) | 761 | 23 | Where the money went this month, and whether it all went somewhere. | 10 |
...
| [NationalAccounts.java](NationalAccounts.md) | 814 | 71 | The city's GDP, measured properly, plus the government's own books. | 12 |
...
| [TaxPolicy.java](TaxPolicy.md) | 668 | 58 | The city's tax rates - the revenue half of what the player actually decides. | 18 |
...
| [WorldEconomy.java](WorldEconomy.md) | 395 | 17 | The rest of the world, which has its own inflation and did not use to. | 7 |
...
| [Retail.java](Retail.md) | 626 | 46 | The shops. | 17 |
...
| [FinancesScreen.java](FinancesScreen.md) | 1,698 | 29 | The Finances tab: the position, the ladder of what the city owes, debt service, home and abroad, your rate taken apart, the book, buying back, and ... | 1 |
...
| [HistoryScreen.java](HistoryScreen.md) | 1,442 | 32 | The Reports tab: the city as a shape over time. | 1 |
...
| [PeopleScreen.java](PeopleScreen.md) | 2,528 | 32 | The People tab and the household screen behind it. | 1 |
...
| [PolicyScreen.java](PolicyScreen.md) | 2,527 | 54 | The policy tab: the four rows of levers - taxes, wages, money, promises - the staged set every dial writes into, the ladder and the batch preview t... | 2 |
...
| [SummaryScreen.java](SummaryScreen.md) | 1,615 | 27 | The left panel's content: the summary and the dashboard - the vitals, the alert block, the six lines that are always worth a glance or the twelve f... | 1 |
...
| [UserInterface.java](UserInterface.md) | 4,038 | 72 | The window: the stage and its theme, the clock and the speed ladder, the two strips, the rail down the left and the inbox, the left panel and the c... | 14 |
...
| [DenominationCheck.java](DenominationCheck.md) | 524 | 14 | A currency reform is a change of units, and this is how we know. | 0 |
...
| [LongPlaytest.java](LongPlaytest.md) | 2,513 | 28 | A city played for four thousand months, the way a person plays. | 4 |
...
| [MiningCheck.java](MiningCheck.md) | 608 | 7 | Ore, from the band it clears in to whether it makes steel worth building. | 0 |
...
| [JavaScan.java](JavaScan.md) | 666 | 39 | A structural read of one Java source file, without a compiler. | 6 |
...
| [SourceTree.java](SourceTree.md) | 154 | 13 | The whole source tree, scanned once, and the little that every generator shares: where the sources are, where the documents go, what area a file be... | 6 |
