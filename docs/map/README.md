...
Generated 2026-09-21 by `ham.citybuildersim.tools.CodeMap` - do not edit; regenerate with `Regenerate maps.bat` (or `Maps`).
...
**The tree:** 206 files, 128,954 lines, 4,943 methods, 733 constants. `GameVersion.VERSION` is "0.6.10", `SAVE_FORMAT` 27.
...
| [Bank.java](Bank.md) | 2,226 | 134 | The city's commercial bank: every loan in it, and every default. | 19 |
...
| [BuildingsTemplate.java](BuildingsTemplate.md) | 730 | 75 | One kind of building, and what it costs to put up. | 72 |
...
| [Currency.java](Currency.md) | 61 | 5 | What the city's money is called, and how it is written. | 9 |
| [DataSave.java](DataSave.md) | 1,343 | 213 | sections: land, ore and the retainer, the shedding warning... | 3 |
| [Debt.java](Debt.md) | 351 | 31 | One piece of city paper. | 14 |
| [DebtManager.java](DebtManager.md) | 1,046 | 81 | sections: THE POLICY RATE, THE RATE THE FOREIGN PAPER IS VALUED AT... | 18 |
...
| [EconomyManager.java](EconomyManager.md) | 1,381 | 181 | The private economy: every sector, every market, the credit desk, the tax policy and the national accounts, and the month they run in. | 32 |
| [Education.java](Education.md) | 934 | 47 | Who the city teaches, what it costs, and why anybody bothers. | 9 |
| [EducationType.java](EducationType.md) | 191 | 11 | What a school actually teaches. | 17 |
...
| [FamilyStructure.java](FamilyStructure.md) | 119 | 7 | The shapes a household comes in. | 26 |
| [ForeignAccounts.java](ForeignAccounts.md) | 1,305 | 70 | The city's dealings with the rest of the world: the balance of payments, the reserve position, and the exchange rate. | 17 |
| [Formats.java](Formats.md) | 56 | 6 | The few formats a sector needs to describe itself, without the toolkit. | 16 |
| [Game.java](Game.md) | 8,230 | 285 | sections: THE FOUNDING RESERVE (2026-09-21), THE CONSTRUCTION SUBSIDY... | 90 |
...
| [GameVersion.java](GameVersion.md) | 708 | 4 | What build this is, and what shape its saves are. | 7 |
...
| [HistorySave.java](HistorySave.md) | 908 | 27 | Every month the city has ever lived, one number at a time. | 11 |
| [Household.java](Household.md) | 1,047 | 88 | Every household of one shape at one pay tier, as one ledger. | 25 |
| [HouseholdAccounts.java](HouseholdAccounts.md) | 1,123 | 84 | The city's residents, treated as one household. | 9 |
| [HouseholdBalance.java](HouseholdBalance.md) | 3,259 | 147 | The households' balance sheet: what they have saved, what they owe, and what happens in the month they cannot cover the shop. | 25 |
...
| [LandParcel.java](LandParcel.md) | 111 | 11 | One plot on the market, as the land office lists it. | 9 |
...
| [MoneyAudit.java](MoneyAudit.md) | 767 | 23 | Where the money went this month, and whether it all went somewhere. | 10 |
...
| [NationalAccounts.java](NationalAccounts.md) | 853 | 75 | The city's GDP, measured properly, plus the government's own books. | 14 |
...
| [PayTier.java](PayTier.md) | 125 | 5 | The six pay levels a household can be in. | 40 |
...
| [PriceIndex.java](PriceIndex.md) | 287 | 16 | What a month costs a household, against what it cost at founding. | 5 |
...
| [ShortTermTBill.java](ShortTermTBill.md) | 125 | 13 | A short-term anticipation note: borrow now, repay one lump, no coupon. | 4 |
...
| [TaxPolicy.java](TaxPolicy.md) | 1,008 | 73 | The city's tax rates - the revenue half of what the player actually decides. | 24 |
...
| [TreasuryJournal.java](TreasuryJournal.md) | 206 | 16 | The treasury's journal: every movement of the city's cash that is neither a budget line nor paper raised or repaid, recorded by name as it happens,... | 5 |
...
| [WorkingHousehold.java](WorkingHousehold.md) | 50 | 7 | A household with an earner in it, at one pay tier. | 2 |
| [WorldEconomy.java](WorldEconomy.md) | 394 | 17 | The rest of the world, which has its own inflation and did not use to. | 7 |
| [YearBook.java](YearBook.md) | 823 | 39 | The run, one line a year - for READING rather than for drawing. | 3 |
...
| file | lines | methods | what it is | used by |
|---|---:|---:|---|---:|
| [BankScreen.java](BankScreen.md) | 1,653 | 23 | The bank tab: the gauge, the two limits, another branch, who owes it, where the money comes from, the books, the rescue, and its history. | 1 |
...
| [GovernmentScreen.java](GovernmentScreen.md) | 1,540 | 39 | The government tab: the budget as two rings and a balance, what the treasury actually did against the size of the economy, the two lists - who pays... | 1 |
| [HistoryScreen.java](HistoryScreen.md) | 1,429 | 32 | The Reports tab: the city as a shape over time. | 1 |
...
| [PeopleScreen.java](PeopleScreen.md) | 2,546 | 32 | The People tab and the household screen behind it. | 1 |
...
| [PolicyScreen.java](PolicyScreen.md) | 2,917 | 60 | The policy tab: the four rows of levers - taxes, wages, money, promises - the staged set every dial writes into, the ladder and the batch preview t... | 2 |
...
| [SummaryScreen.java](SummaryScreen.md) | 1,632 | 27 | The left panel's content: the summary and the dashboard - the vitals, the alert block, the six lines that are always worth a glance or the thirteen... | 1 |
| [TradeScreen.java](TradeScreen.md) | 1,764 | 26 | The Trade & the world tab: the landing with its vitals, the month as a river, the reserves, the currency, what we trade, and the three quiet gauges. | 1 |
| [UserInterface.java](UserInterface.md) | 4,179 | 75 | The window: the stage and its theme, the clock and the speed ladder, the two strips, the rail down the left and the inbox, the left panel and the c... | 14 |
...
| [BankCheck.java](BankCheck.md) | 1,202 | 6 | The commercial bank, and the families it discharges. | 0 |
...
| [EducationCheck.java](EducationCheck.md) | 1,106 | 11 | Verifies the schools: who gets taught, who is allowed to practise, and what it costs. | 0 |
...
| [ForeignCheck.java](ForeignCheck.md) | 1,328 | 11 | The balance of payments, and whether the boundary it is drawn on is honest. | 0 |
| [ForeignDebtCheck.java](ForeignDebtCheck.md) | 598 | 5 | Borrowing in somebody else's money. | 0 |
...
| [LongPlaytest.java](LongPlaytest.md) | 2,741 | 30 | A city played for four thousand months, the way a person plays. | 4 |
...
| [NewGameCheck.java](NewGameCheck.md) | 355 | 5 | Does "Start New Game" actually start a new game? | 1 |
...
| [ReadPathCheck.java](ReadPathCheck.md) | 506 | 5 | Reading the city must not change the city. | 0 |
...
| [SaveFileCheck.java](SaveFileCheck.md) | 1,149 | 7 | Verifies where saves go and how they are written. | 0 |
...
| [TreasuryCheck.java](TreasuryCheck.md) | 417 | 6 | Plays a city and audits what the screens say the treasury did. | 0 |
