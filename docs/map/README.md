...
Generated 2026-09-22 by `ham.citybuildersim.tools.CodeMap` - do not edit; regenerate with `Regenerate maps.bat` (or `Maps`).
...
**The tree:** 212 files, 139,614 lines, 5,341 methods, 794 constants. `GameVersion.VERSION` is "0.7.3", `SAVE_FORMAT` 27.
...
| [Bank.java](Bank.md) | 2,441 | 146 | The city's commercial bank: every loan in it, and every default. | 22 |
...
| [DataSave.java](DataSave.md) | 1,462 | 230 | sections: land and ore, the shedding warning... | 3 |
| [Debt.java](Debt.md) | 473 | 44 | One piece of city paper. | 18 |
| [DebtManager.java](DebtManager.md) | 1,471 | 110 | The city's borrowing: every bond, note and dollar bond the treasury owes, the market that prices the next one, and the policy rate every price of m... | 22 |
...
| [EconomyManager.java](EconomyManager.md) | 1,401 | 184 | The private economy: every sector, every market, the credit desk, the tax policy and the national accounts, and the month they run in. | 32 |
...
| [ForeignAccounts.java](ForeignAccounts.md) | 1,606 | 84 | The city's dealings with the rest of the world: the balance of payments, the reserve position, and the exchange rate. | 20 |
| [Formats.java](Formats.md) | 56 | 6 | The few formats a sector needs to describe itself, without the toolkit. | 16 |
| [Game.java](Game.md) | 9,278 | 323 | sections: THE FOUNDING RESERVE (2026-09-21), THE CONSTRUCTION SUBSIDY - removed in 0.7.1... | 93 |
| [GameFiles.java](GameFiles.md) | 401 | 31 | Where the game keeps its files, and how it writes them. | 64 |
...
| [GameVersion.java](GameVersion.md) | 1,071 | 4 | What build this is, and what shape its saves are. | 7 |
...
| [HistorySave.java](HistorySave.md) | 940 | 27 | Every month the city has ever lived, one number at a time. | 12 |
...
| [MoneyAudit.java](MoneyAudit.md) | 894 | 24 | Where the money went this month, and whether it all went somewhere. | 13 |
...
| [NationalAccounts.java](NationalAccounts.md) | 887 | 78 | The city's GDP, measured properly, plus the government's own books. | 14 |
...
| [TreasuryJournal.java](TreasuryJournal.md) | 219 | 16 | The treasury's journal: every movement of the city's cash that is neither a budget line nor paper raised or repaid, recorded by name as it happens,... | 6 |
...
| [YearBook.java](YearBook.md) | 828 | 39 | The run, one line a year - for READING rather than for drawing. | 3 |
...
| file | lines | methods | what it is | used by |
|---|---:|---:|---|---:|
| [BankScreen.java](BankScreen.md) | 1,665 | 23 | The bank tab: the gauge, the two limits, another branch, who owes it, where the money comes from, the books, the rescue, and its history. | 1 |
| [BuildScreen.java](BuildScreen.md) | 1,726 | 37 | The build tab: the strip of categories across the top, the constraints bar that says what stops a build, the line that says who builds these, and e... | 2 |
...
| [GovernmentScreen.java](GovernmentScreen.md) | 1,602 | 39 | The government tab: the budget as two rings and a balance, what the treasury actually did against the size of the economy, the two lists - who pays... | 1 |
...
| [PolicyScreen.java](PolicyScreen.md) | 3,060 | 60 | The policy tab: the four rows of levers - taxes, wages, money, promises - the staged set every dial writes into, the ladder and the batch preview t... | 2 |
...
| [TradeScreen.java](TradeScreen.md) | 1,836 | 26 | The Trade & the world tab: the landing with its vitals, the month as a river, the reserves, the currency, what we trade, and the three quiet gauges. | 1 |
| [UserInterface.java](UserInterface.md) | 4,204 | 75 | The window: the stage and its theme, the clock and the speed ladder, the two strips, the rail down the left and the inbox, the left panel and the c... | 14 |
...
| [EducationCheck.java](EducationCheck.md) | 1,110 | 11 | Verifies the schools: who gets taught, who is allowed to practise, and what it costs. | 0 |
...
| [ForeignCheck.java](ForeignCheck.md) | 1,377 | 11 | The balance of payments, and whether the boundary it is drawn on is honest. | 1 |
...
| [LongPlaytest.java](LongPlaytest.md) | 3,263 | 37 | A city played for four thousand months, the way a person plays. | 6 |
...
| [MonetaryCheck.java](MonetaryCheck.md) | 554 | 10 | Money: what a basket costs, what the world charges, and what the rate does. | 1 |
...
| [NewGameCheck.java](NewGameCheck.md) | 354 | 5 | Does "Start New Game" actually start a new game? | 1 |
...
| [ReadPathCheck.java](ReadPathCheck.md) | 544 | 5 | Reading the city must not change the city. | 0 |
...
| [TreasuryCheck.java](TreasuryCheck.md) | 427 | 6 | Plays a city and audits what the screens say the treasury did. | 0 |
