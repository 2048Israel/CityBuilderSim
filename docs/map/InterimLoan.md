...
`ham/citybuildersim/InterimLoan.java` - generated 2026-09-26 by CodeMap; line numbers are as of that run.
...
**Uses:** [BusinessLoan](BusinessLoan.md) (1)

**Used by (4):** [BusinessDebtManager](BusinessDebtManager.md), [CreditCheck](CreditCheck.md), [Game](Game.md), [LongPlaytest](LongPlaytest.md)
...
|---:|---:|---|---|
| 26 | 10 | **type** `public class InterimLoan extends BusinessLoan` | Interim financing: the bank's loan to a sector in the month it defaulted, for what the month's bills left unpaid after its debt was written down, ranked ahead of everything else the sector owes. |
| 31 | 4 | `public InterimLoan(String sector, double faceValue, int months, int monthStarted, double annualRate)` |  |
