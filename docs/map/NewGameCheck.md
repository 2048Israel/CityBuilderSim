# NewGameCheck.java - 355 lines · 5 methods · 0 constants · harnesses
...
| 250 | · 3. start a new one |
| 271 | · 4. and it is actually playable |
| 297 | · 5. a new game after a LOAD, too |
...
|---:|---:|---|---|
| 27 | 329 | **type** `public class NewGameCheck` | Does "Start New Game" actually start a new game? |
...
| 182 | 165 | `public static void main(String[] args) throws Exception` |  |
| 348 | 7 | `static void cleanUp(Path root)` |  |
