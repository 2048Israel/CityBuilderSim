...
| 134 | · 2. the emigrants |
| 187 | · 3. the world |
| 239 | · 4. the households |
| 290 | · 4b. and when the model prices two of them the same |
| 383 | · 5. the distress sale |
| 423 | · 5b. the world's paper |
| 468 | · 6. the buyback, and the special dividend |
| 561 | · 7. the split |
| 596 | · 8. the save |
| 618 | · 9. a live city |
...
|---:|---:|---|---|
| 21 | 666 | **type** `public class ExchangeCheck` | Verifies the exchange: what the desk quotes, who trades with it and why, what a company does with its surplus, and that a city with a market in it still adds up and survives a save. |
