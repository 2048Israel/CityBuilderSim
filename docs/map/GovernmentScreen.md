...
### THE TWO LISTS. (lines 755-940)

| line | len | member | says |
|---:|---:|---|---|
| 768 | 6 | `static java.util.List<String> revenueNames()` |  |
| 775 | 23 | `java.util.List<Double> revenueAmounts(EconomyManager em, NationalAccounts na)` |  |
| 799 | 5 | `static java.util.List<String> spendingNames()` |  |
| 816 | 21 | `java.util.List<Double> spendingAmounts(EconomyManager em, NationalAccounts na)` | REPAIRS JOINED THIS LIST ON 2026-09-09, and it is a real line rather than a nicety. |
| 845 | 4 | `VBox budgetLine(String label, double amount, double total, double annual, String colour, VBox detail)` | A line of the budget that opens into whoever paid it. |
| 855 | 61 | `VBox budgetLine(String label, double amount, double total, double annual, String colour, VBox detail, String word)` | city pays interest. |
